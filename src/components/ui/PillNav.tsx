...
// React Bits · Pill Nav（适配 Next.js：react-router Link → next/link，新增 logoHref）
...
const PillNav: React.FC<PillNavProps> = ({
  ...
  return (
    <div className="fixed top-4 z-[1000] w-full left-0 px-4 md:px-0 md:w-auto md:left-1/2 md:-translate-x-1/2">
      <nav
        className={`w-full md:w-max flex items-center justify-between md:justify-start box-border pr-16 md:pr-0 ${className}`}
        aria-label="Primary"
        style={cssVars}
      >
        <Link
